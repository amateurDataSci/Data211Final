...
NewCalories<-Calories%>%
  rename(`My Average`=`Ultra-Processed`)%>%
...
$p_m:$percentage of my ultra-processed calories.

$p_a:$percentage of American average ultra-processed calories.

$H_0:p_m=p_a$ vs. $H_1:p_m<p_a$
